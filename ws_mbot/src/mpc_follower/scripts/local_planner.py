...
from geometry_msgs.msg import Pose, PoseArray, PoseStamped, Point, Twist, PoseWithCovarianceStamped
...
class Local_Planner():
    def __init__(self):
        self.replan_period = 0.020 # 调用MPC求解的频率，需要与MPC的离散时间保持一致
        ...
        self._sub_odom = rospy.Subscriber('/amcl_pose', PoseWithCovarianceStamped, self.__pose_cb)                              # 里程的订阅者，订阅里程计获得小车的位置
